function[]=discourse()
    ...
    Train_Tree='../train_tree.txt';
    %Train_Tree='small_tree.txt';
    Test_Tree='../test_tree.txt';
    Train_Text='../train_text.txt';
    %Train_Text='small_text.txt';
    Test_Text='../test_text.txt';
    Train_Trees=ReadTrees(Train_Tree,1);
    Test_Trees=ReadTrees(Test_Tree,0);
    ...
    for iter=1:5
        ...
        toc
        iter
        Infer(Test_Trees,Test_Text,parameter)
        %testing(parameter,Test_Trees,Test_Text);
    end
end
...
function[parameter,ada]=Initial(parameter)
    ...
    parameter.vect=gpuArray(load('../discourse_wordvector.txt'))';
