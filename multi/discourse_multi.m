function[]=discourse_multi()
    addpath('../misc');
    parameter.alpha=0.01;
    parameter.gpu_index=2;
    ...
    parameter=ReadRelation(parameter);
    Train_Trees=ReadTrees(Train_Tree,1,parameter);
...
function[parameter,ada]=Initial(parameter)
    ...
    parameter.U=randomMatrix(parameter.Initial,[41,parameter.dimension]);
